		...
		<main>
			...
			<div id="soaps" class="hello">
				<div class="soap">
					...
					<button type="button" onclick="<?php array_push($productArray, "Lavender Soap") ?>">Add to Cart</button>
				...
				<div class="soap">
					...
					<button type="button" onclick="<?php array_push($productArray, "Mint Soap") ?>">Add to Cart</button>
				</div>
				<div class="soap">
					<div class="description">
